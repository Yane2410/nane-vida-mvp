  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="relative p-8 sm:p-10 text-center">
        ...
        <h1 className="text-h1 text-slate-900 dark:text-gray-100 font-bold mb-3">
          {getGreeting()}
        </h1>
        
        <p className="text-body-lg text-slate-800 dark:text-gray-200 font-medium max-w-2xl mx-auto">
          {getSubtitle()}
        </p>
      </div>
