...
const Button = memo(function Button({
  ...
  const variants = {
    ...
    secondary: 'glass text-gray-900 dark:text-gray-100 border-2 border-primary-400/20 dark:border-primary-500/30 hover:border-primary-400/40 dark:hover:border-primary-500/50 focus:ring-primary-100 dark:focus:ring-primary-800 active:scale-[0.98]',
    ghost: 'bg-gradient-to-br from-warmth to-warmth-light dark:from-warmth-dark dark:to-warmth text-gray-900 dark:text-gray-100 hover:shadow-warmth/50 dark:hover:shadow-warmth/40 focus:ring-warmth/20 dark:focus:ring-warmth/30 active:scale-[0.98] border-2 border-white/20 dark:border-white/10',
    ...
    success: 'bg-gradient-to-br from-energy to-energy-light dark:from-energy-dark dark:to-energy text-gray-900 dark:text-gray-100 hover:shadow-energy/50 dark:hover:shadow-energy/40 focus:ring-energy/20 dark:focus:ring-energy/30 active:scale-[0.98] border-2 border-white/20 dark:border-white/10'
  }
