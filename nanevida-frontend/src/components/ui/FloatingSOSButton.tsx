  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* Tooltip on hover */}
        <div className="absolute bottom-full right-0 mb-2 px-3 py-1.5 bg-slate-900 dark:bg-foreground text-white dark:text-background text-xs font-medium rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none shadow-lg">
          Ayuda de emergencia
