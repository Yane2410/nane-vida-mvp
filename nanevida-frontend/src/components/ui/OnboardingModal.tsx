          ...
          <div className="p-8 sm:p-12">
            ...
            <AnimatedCore mode="fadeIn" duration={500} loop={false}>
              <div className="text-center mb-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-gray-100 mb-4">
                  {step.title}
                </h2>
                <p className="text-base sm:text-lg text-black dark:text-gray-100 leading-relaxed max-w-xl mx-auto">
                  {step.description}
                </p>
              </div>
            </AnimatedCore>
