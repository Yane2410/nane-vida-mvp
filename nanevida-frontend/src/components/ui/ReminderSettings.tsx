                  ...
                  <div className="flex flex-wrap items-center gap-2 text-sm">
                    ...
                    <div className="flex gap-1">
                      {reminder.days.map(day => (
                        <span
                          key={day}
                          className="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-black dark:text-white rounded-lg text-xs font-medium"
                        >
                          {DAYS[day]}
                        </span>
                      ))}
      ...
      {isAdding && (
        <Card className="border-2 border-primary-400/40 dark:border-primary-500/40">
          ...
          <div className="space-y-4">
            {/* Type */}
            <div>
              <label className="block text-sm font-medium text-slate-900 dark:text-white dark:text-slate-200 mb-2">
