                ...
                <div className="relative" style={{ width: `${circleSize}px`, height: `${circleSize}px` }}>
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className={`${isSmall ? 'text-lg' : 'text-xl'} font-medium text-black dark:text-white`}>
            ...
            {completedCycles >= 3 && (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-black dark:text-white text-sm text-left">
            ...
            >
              <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full">
                <div className="mb-4">
                  ...
                  <p className={`text-black dark:text-white mb-4 ${isSmall ? 'text-sm' : ''}`}>
                    {pattern.description}
                  </p>
                </div>
              ...
              <div className="space-y-2 mb-4">
                {pattern.cycles.map((cycle, idx) => (
                  ...
                  >
                    <span className="text-black dark:text-white">{cycle.instruction}</span>
                    <span className="font-bold text-black dark:text-white">{cycle.duration}s</span>
                  </div>
                ))}
              </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-start gap-2">
              ...
              <span className="text-slate-900 dark:text-white dark:text-slate-200">Reduce la ansiedad y el estrés</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-[#22C55E] font-bold mt-1">✓</span>
              <span className="text-slate-900 dark:text-white dark:text-slate-200">Mejora la concentración</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-[#22C55E] font-bold mt-1">✓</span>
              <span className="text-slate-900 dark:text-white dark:text-slate-200">Calma el sistema nervioso</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-[#22C55E] font-bold mt-1">✓</span>
              <span className="text-slate-900 dark:text-white dark:text-slate-200">Ayuda a conciliar el sueño</span>
            </div>
          </div>
        </Card>
