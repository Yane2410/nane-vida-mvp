      ...
      <div className="min-h-screen bg-gradient-to-br from-[#F7F5FF] via-white to-[#E0F2FE] p-4 sm:p-8 flex items-center justify-center animate-fadeIn">
        <CenteredContainer padding="md" fullHeight>
          <Card className="text-center">
                ...
                <div className="relative" style={{ width: `${circleSize}px`, height: `${circleSize}px` }}>
                  ...
                  >
                    <div className="text-center">
                      <div className={`${isSmall ? 'text-5xl' : 'text-6xl'} font-bold text-black dark:text-gray-100 mb-2`}>
                        {secondsLeft}
                      </div>
                      <div className={`${isSmall ? 'text-lg' : 'text-xl'} font-medium text-black dark:text-gray-100`}>
            ...
            {/* Haptics Toggle */}
            {haptics.isAvailable() && (
              <div className="flex items-center justify-center gap-2 text-sm text-black dark:text-gray-100">
                <input
                  type="checkbox"
                  id="haptics-toggle"
            ...
            {completedCycles >= 3 && (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-black dark:text-gray-100 text-sm text-left">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F7F5FF] via-white to-[#E0F2FE] p-4 sm:p-8 animate-fadeIn">
      <CenteredContainer padding="md">
            ...
            >
              <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 h-full">
                <div className="mb-4">
                  ...
                  <h3 className={`${isSmall ? 'text-lg' : 'text-xl'} font-bold text-black dark:text-gray-100 mb-2`}>
                    {pattern.name}
                  </h3>
                  <p className={`text-black dark:text-gray-100 mb-4 ${isSmall ? 'text-sm' : ''}`}>
                    {pattern.description}
                  </p>
                </div>
              ...
              <div className="space-y-2 mb-4">
                {pattern.cycles.map((cycle, idx) => (
                  ...
                  >
                    <span className="text-black dark:text-gray-100">{cycle.instruction}</span>
                    <span className="font-bold text-black dark:text-gray-100">{cycle.duration}s</span>
                  </div>
                ))}
              </div>
        ...
        >
          <h3 className="text-xl font-bold text-black dark:text-gray-100 mb-4 flex items-center gap-2">
