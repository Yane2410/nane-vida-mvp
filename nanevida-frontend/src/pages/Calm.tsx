      ...
      <CenteredContainer padding="md" fullHeight>
        ...
        <Card className="mb-6 text-center min-h-[200px] flex items-center justify-center">
          <div className="max-w-xl mx-auto">
            <p className={`${isSmall ? 'text-lg' : isTablet ? 'text-xl' : 'text-2xl'} text-black dark:text-white leading-relaxed font-medium`}>
        ...
        {/* Haptics Toggle */}
        {haptics.isAvailable() && (
          <div className="flex items-center justify-center gap-2 text-sm text-black dark:text-white mt-4">
            <input
              type="checkbox"
          ...
          <Card key={technique.id} hover className="flex flex-col">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className={`${isSmall ? 'text-lg' : 'text-xl'} font-bold text-black dark:text-white mb-1`}>
                  {technique.title}
                </h3>
