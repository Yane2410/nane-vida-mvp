  ...
  return (
    <div className="min-h-screen py-8 space-y-8 animate-fadeIn">
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-4 mb-8">
        ...
        />
        <p className="text-lg sm:text-xl text-slate-900 dark:text-gray-100 max-w-2xl px-4">
      ...
      <Card gradient animated>
        <div className="text-center mb-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-black dark:text-gray-100 mb-3">
            ¿Cómo te sientes hoy?
          </h2>
          <p className="text-base sm:text-lg text-black dark:text-gray-100 max-w-xl mx-auto">
      ...
      <div>
        <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-gray-100 mb-6 text-center">
