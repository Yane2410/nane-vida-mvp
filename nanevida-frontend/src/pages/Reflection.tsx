            ...
            >
              <div className="text-center">
                ...
                <AnimatedCore mode="fadeIn" duration={800} loop={false}>
                  <h2 className={`font-bold text-black dark:text-white mb-3 ${isSmall ? 'text-xl' : isTablet ? 'text-2xl' : 'text-3xl'}`}>
                    {selectedPrompt.question}
                  </h2>
                  <p className={`text-black dark:text-white ${isSmall ? 'text-sm' : 'text-base'}`}>
        ...
        <div className="w-full max-w-5xl mx-auto">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h1 className={`font-bold text-black dark:text-white mb-2 ${isSmall ? 'text-2xl' : 'text-3xl'}`}>
                  Reflexión Guiada
                </h1>
